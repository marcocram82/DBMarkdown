...
<!--
dbo.ORG_FORMULARIOS_PREDEFINIDOS_UTILIZADORES
dbo.STD_DETALHE_TIPO_RESPOSTA_FOMULARIOS_ITENS_LISTA
dbo.STD_FORMULARIOS_PERSONALIZADOS
dbo.STD_GRUPOS_PERGUNTAS_FORMULARIOS
dbo.STD_PERGUNTAS_FORMULARIOS
M1PATIENT.CustomForm
M1ORGANIZATION.CustomFormLayout
M1ORGANIZATION.CustomFormPhysicalTherapyLink
M1ORGANIZATION.CustomFormResultIntervalActionNursingPrescriptionGroup
M1ORGANIZATION.CustomSpecialtyChartMedicalNoteLink
M1ORGANIZATION.DentalRecordAreaCustomFormLink
dbo.STD_FORMULARIOS_FICHAS_ESPECIALIDADE
dbo.ORG_LIGACOES_FORMULARIOS_SECTORES
dbo.STD_TIPOS_RESPOSTAS_FORMULARIOS
M1LIST.CustomFormMandatoryAnswerDefinition
M1LIST.CustomFormVisibilityAnswerDefinition
M1LIST.CustomFormMandatoryAnswerDetail
M1LIST.CustomFormVisibilityAnswerDetail
-->
<details open>
  <summary>Ver diagrama (Configuração)</summary>
